...
# No #kids: it signals "made for kids", which risks the COPPA treatment that
# disables comments — and comments are the whole engagement play.
_HASHTAGS = ["#shorts", "#wouldyourather", "#quiz", "#fun", "#challenge"]
